...
class UsersControllerRegistration extends UsersController
{
	...
	public function activate()
	{
		...
		$uParams	= JComponentHelper::getParams('com_cvnusers');
		...
		elseif ($return->getParam('activate'))
		{
			...
			$this->setRedirect(JRoute::_('index.php?option=com_cvnusers&view=registration&layout=complete', false));
		}
		else
		{
	...
	public function register()
	{
		...
		if ($data === false) {
			...
			$app->setUserState('com_cvnusers.registration.data', $requestData);

			// Redirect back to the registration screen.
			$this->setRedirect(JRoute::_('index.php?option=com_cvnusers&view=registration', false));
			return false;
		}
		...
		if ($return === false) {
			// Save the data in the session.
			$app->setUserState('com_cvnusers.registration.data', $data);
		...
		$app->setUserState('com_cvnusers.registration.data', null);
