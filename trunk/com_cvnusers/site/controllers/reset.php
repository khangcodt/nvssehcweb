...
class UsersControllerReset extends UsersController
{
	...
	public function request()
	{
		...
		if ($return instanceof Exception) {
			...
			$route	= 'index.php?option=com_cvnusers&view=reset'.$itemid;
			...
			$itemid = UsersHelperRoute::getResetRoute();
			$itemid = $itemid !== null ? '&Itemid='.$itemid : '';
			$route	= 'index.php?option=com_cvnusers&view=reset&layout=confirm'.$itemid;
	...
	function confirm()
	{
		...
		if ($return instanceof Exception)
		{
			...
			$itemid = UsersHelperRoute::getResetRoute();
			$itemid = $itemid !== null ? '&Itemid='.$itemid : '';
			$route	= 'index.php?option=com_cvnusers&view=reset&layout=complete'.$itemid;
