...
<script type="text/javascript">
	...
	{
		if (task == 'autosetting.cancel' || document.formvalidator.isValid(document.id('chessvn-form')))
		{
...
<input type="hidden" name="autosettingid" value="<?php echo $this->item->autosettingid; ?>" />
