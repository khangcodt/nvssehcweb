...
<script type="text/javascript">
	...
	{
		if (task == 'autoplayer.cancel' || document.formvalidator.isValid(document.id('chessvn-form')))
		{
...
<input type="hidden" name="autoplayerid" value="<?php echo $this->item->autoplayerid; ?>" />
