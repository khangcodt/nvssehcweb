 ...
 * @subpackage 	Chessvn
 */
class ChessvnControllerBuddyblacklistlist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Buddyblacklist', $prefix = 'ChessvnModel', $cfg = array('ignore_request' => true)){
