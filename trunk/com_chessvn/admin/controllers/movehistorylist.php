 ...
 * @subpackage 	Chessvn
 */
class ChessvnControllerMovehistorylist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Movehistory', $prefix = 'ChessvnModel', $cfg = array('ignore_request' => true)){
