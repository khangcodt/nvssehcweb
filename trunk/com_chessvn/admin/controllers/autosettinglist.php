 ...
 * @subpackage 	Chessvn
 */
class ChessvnControllerAutosettinglist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Autosetting', $prefix = 'ChessvnModel', $cfg = array('ignore_request' => true)){
