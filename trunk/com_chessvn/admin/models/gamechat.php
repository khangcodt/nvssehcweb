 ...
 * @subpackage 	Chessvn
 */
class ChessvnModelGamechat extends JModelAdmin{
	/**
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		return JFactory::getUser()->authorise('core.edit', 'com_chessvn.gamechat.'.((int) isset($data[$key]) ? $data[$key] : 0)) or parent::allowEdit($data, $key);
	}
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Gamechat', $prefix = 'ChessvnTable', $config = array()) 
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_chessvn.gamechat', 'gamechat', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
	...
	{
		return 'administrator/components/com_chessvn/models/forms/gamechat.js';
	}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_chessvn.edit.gamechat.data', array());
		if (empty($data)) 
		{
			$data = $this->getItem();
		}
