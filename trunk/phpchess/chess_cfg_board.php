<?php
  ...
  $Contentpage = "cell_cfg_board.php";  
  ...
  $cmdSetBoard = $_POST['cmdSetBoard'];
  $slcBoardLayout = $_POST['slcBoardLayout'];
  $slcBoardType = $_POST['slcBoardType'];

  if($slcBoardLayout != "" && $cmdSetBoard != ""){
    $oR3DCQuery->SetBoardStyleByUserID($_SESSION['id'], $slcBoardLayout);
  }

  if($slcBoardType != "" && $cmdSetBoard != ""){
    $oR3DCQuery->SetBoardCustomerSetting($_SESSION['id'], $slcBoardType);
  }

  $selected = $oR3DCQuery->GetBoardStyleByUserID($_SESSION['id']);
