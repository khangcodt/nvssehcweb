...
<?php
/////////////////////////////////////////////////////////////////////////
// Exit Realtime if it is enabled
/////////////////////////////////////////////////////////////////////////
if($isexitrealtime == true){
?>
<script language="javascript"> 
<?php
  echo "parent.location.href = './chess_game1.php?gameid=".$gid."'";
?>
</script>
<?php
}
...
<form name='frmAccept' method='get' action='./chess_game1.php'>
...
<?php
  ...
  if($move_promotion_figur && strlen($movestr2)==5){
    ...
    $url = "chess_game1.php?txtmovefrom=".$movefrom."&txtmoveto=".$moveto;
...
<?php
    ...
    echo "<form name='frmcolor' method='get' action='./chess_game1.php'>";
...
<form name='frmRevokeDraw' method='get' action='./chess_game1.php'>
<table border='0' cellpadding='0' cellspacing='0' align='center' width='95%'>
<tr>
...
<?php
      ...
      echo "<form name='frmcolor' method=\"GET\" action='./chess_game1.php'>";
      $oR3DCQuery->GetGameStatus($config, $gid, $_SESSION['sid'], $_SESSION['id'], get_completion_status(), $clrl, $clrd, $oR3DCQuery->GetBoardStyleByUserID($_SESSION['id']), 1, 'dd');
      echo "<input type='hidden' name='gameid' value='".$gid."'>";
      echo "</form>";
