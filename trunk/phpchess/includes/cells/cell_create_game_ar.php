...
?>
<form name='frmCreateGame' method='get' action='./chess_create_game_ar.php'>
...
?>
<option value='C-Blitz'><?php echo GetStringFromStringTable("IDS_CREATE_GAME_OPT_1", $config). ' ('. $durations['blitz'] . ')'; ?></option>
<option value='C-Short'><?php echo GetStringFromStringTable("IDS_CREATE_GAME_OPT_2", $config). ' ('. $durations['short'] .  ')';?></option>
<option value='C-Normal'><?php echo GetStringFromStringTable("IDS_CREATE_GAME_OPT_3", $config). ' ('. $durations['normal'] . ')';?></option>
<option value='C-Slow'><?php echo GetStringFromStringTable("IDS_CREATE_GAME_OPT_4", $config). ' ('. $durations['slow'] . ')';?></option>
<option value='C-Snail'><?php echo GetStringFromStringTable("IDS_CREATE_GAME_OPT_5", $config). ' ('. $durations['snail'] .')';?></option>
</select>
