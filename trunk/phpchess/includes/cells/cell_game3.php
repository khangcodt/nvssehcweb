...
<?php
/////////////////////////////////////////////////////////////////////////
// Used to check if the client is in realtime mode
/////////////////////////////////////////////////////////////////////////
if($isexitrealtime == true){
?>
<script language="javascript"> 
<?php
  echo "parent.location.href = './chess_game3.php?gameid=".$gid."'";
?>
</script>
<?php
}
...
<form name='frmAccept' method='get' action='./chess_game3.php'>
...
<?php
  ...
  if($move_promotion_figur && strlen($movestr2)==5) {
    $url = "chess_game3.php?txtmovefrom=".$movefrom."&txtmoveto=".$moveto;
    if(trim(get_turn()) == "b"){
      //black	
      $queen_img = "08.gif";
      $rook_img = "09.gif";
...
<?php
    ...
    echo "<form name='frmcolor' method='get' action='./chess_game3.php'>";
...
<form name='frmRevokeDraw' method='get' action='./chess_game3.php'>
<table border='0' cellpadding='0' cellspacing='0' align='center' width='95%'>
<tr>
...
<script language="javascript">
<!-- 
location.replace('./rt_index.php?gid=<?php echo $gid;?>&pn=<?php echo $_SESSION['user'];?>');
-->
</script>
<?php
...
<?php
      ...
      echo "<form name='frmcolor' method='get' action='./chess_game3.php'>";
      $oR3DCQuery->GetGameStatus($config, $gid, $_SESSION['sid'], $_SESSION['id'], get_completion_status(), $clrl, $clrd, $oR3DCQuery->GetBoardStyleByUserID($_SESSION['id']), 3, 'dd');
      echo "<input type='hidden' name='gameid' value='".$gid."'>";
      echo "</form>";
