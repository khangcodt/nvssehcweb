...
<form name='frmManageuser' method='post' action='./cfg_userreg.php'>
<table border='0' align='center' class="forumline" cellpadding="3" cellspacing="1" width='100%'>
<tr>
<td colspan='2' class='tableheadercolor'><b><font class="sitemenuheader"><?php echo GetStringFromStringTable("IDS_ADMIN_USERREG_TABLE_HEADER", $config);?></font><b></td>
</tr>

<tr>
<td colspan='2' class='row2'><?php echo GetStringFromStringTable("IDS_ADMIN_USERREG_TXT_1", $config);?></td>
</tr>
