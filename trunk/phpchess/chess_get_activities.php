<?php
  ...
  $Contentpage = "cell_chess_get_activities.php";  
  ...
  if($purchaseid != ""){
    $oR3DCQuery->PlayerPurchaseActivity($_SESSION['id'], $purchaseid);
    header("Location: ./chess_get_activities.php?tag=".$tag."&msg=PA");
  }
...
<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_56", $config);?></title>
