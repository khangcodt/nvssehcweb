<?php
  ...
  $Contentpage = "cell_cfg_chessboard.php";  
  ...
  if($_GET['txtl'] != "" && $_GET['txtd'] != "" && $_GET['cmdchgcolor'] !=""){

    $oR3DCQuery->UpdateChessBoardColors($config, $_SESSION['id'], $_GET['txtl'], $_GET['txtd']);

    $_SESSION['lcolor'] = $_GET['txtl'];
    $_SESSION['dcolor'] = $_GET['txtd'];
