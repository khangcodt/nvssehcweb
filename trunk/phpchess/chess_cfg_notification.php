<?php
  ...
  $Contentpage = "cell_cfg_notification.php";  
  ...
  $slctmove = $_POST['slctmove'];
  $slctchallange = $_POST['slctchallange'];
  $cmdSave= $_POST['cmdSave'];

  if($cmdSave != "" && $slctmove != "" && $slctchallange != ""){
    $oR3DCQuery->SaveNotification($config, $slctmove, $slctchallange, $_SESSION['id']);
  }

  $oR3DCQuery->GetNotification($config, $slctmove, $slctchallange, $_SESSION['id']);
