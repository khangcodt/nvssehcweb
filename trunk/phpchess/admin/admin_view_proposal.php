<?php
  ...
  $Contentpage = "cell_admin_view_proposal.php";  
  ...
  */
  ...
  if($txtcommand != ""){
    ...
    if($txtcommand == 2){
      $oR3DCQuery->StartTournamentGameRound($config, $TID, $TIME);
...
<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_25", $config);?></title>
