<?php
  ...
  $Contentpage = "cell_cfg_ratings.php";  
  ...
  $slctmove = trim($_POST['slctmove']);
  $cmdSave1 = $_POST['cmdSave1'];
  ...
  if($cmdSave1 != "" && $txtvalue != ""){
    $oR3DCQuery->SetDBPointValue($txtvalue);
  }

  $pointvalue = $oR3DCQuery->GetDBPointValue();
