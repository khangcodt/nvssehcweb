<?php
  ...
  $Contentpage = "cell_admin_manage_redemption.php";  
  ...
  $slctTerm = $_POST['slctTerm'];
  $cmdCreate = $_POST['cmdCreate'];

  $RedemptionCode = "";

  if($txtUName != "" && $cmdCreate != ""){
    $RedemptionCode = base64_encode($txtUName."|".$slctTerm."|".$today);
  }
