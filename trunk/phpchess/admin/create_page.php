<?php
  ...
  $Contentpage = "cell_admin_create_page.php";  
  ...
  $AID = $_GET['aid'];
  $AIDx = $_POST['aid'];
  $slctResource = $_POST['slctResource'];
  $content2 = $_POST['content2'];
  $slctType = $_POST['slctType'];
  $txtsolution = $_POST['txtsolution'];
  ...
  if($AIDx != "" && $slctResource != "" && $content2 != "" && $slctType != "" && $cmdSubmit != ""){
    $oR3DCQuery->CreateActivityPage($AIDx, $slctResource, $content2, $slctType, $txtsolution);
    $ViewFinished = true;
  }
...
<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_54", $config);?></title>
