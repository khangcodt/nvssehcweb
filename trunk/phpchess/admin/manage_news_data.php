<?php
  ...
  $Contentpage = "cell_admin_manage_news_data.php";  
...
<html>
<head>
<title><?php echo __l('Administration Page - News/Misc Data'); //echo GetStringFromStringTable("IDS_PAGETITLES_7", $config);?></title>
