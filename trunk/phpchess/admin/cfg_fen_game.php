<?php
  ...
  $Contentpage = "cell_cfg_fen_game.php";  
  ...
  if($cmdChange != ""){
    $oR3DCQuery->SetServerEmailSettings($txtsmtp, $txtsmtpport, $txtuser, $txtpass, $txtdomain);
  }

  $oR3DCQuery->GetServerEmailSettings($smtp, $port, $user, $pass, $domain);
...
<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_35", $config);?></title>
