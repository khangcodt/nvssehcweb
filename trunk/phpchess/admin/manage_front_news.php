<?php
  ...
  $Contentpage = "cell_admin_manage_front_news.php";  
  ...
  $cmdNew = $_POST['cmdNew'];
  $cmdEdit = $_POST['cmdEdit'];
  $cmdDelete = $_POST['cmdDelete'];
  $cmdAdd = $_POST['cmdAdd'];
  $txtnews = $_POST['txtnews'];
  $txttitle = $_POST['txttitle'];
  $rdodelete = $_POST['rdodelete'];

  if($cmdAdd != "" && $txtnews != "" && $txttitle != ""){
    $oFrontNews->AddFrontNews($txttitle, $txtnews);
  }

  $cmdEditItem = $_POST['cmdEditItem'];
  $txtID = $_POST['txtID'];

  if($cmdEditItem != "" && $txtID != "" && $txtnews != "" && $txttitle != ""){
    $oFrontNews->EditFrontNews($txtID, $txttitle, $txtnews);
  }

  if($cmdDelete != "" && $rdodelete != ""){
    $oFrontNews->DeleteFrontNews($rdodelete);
  }
