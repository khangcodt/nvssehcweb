<?php
  ...
  $Contentpage = "cell_admin_cfg_cronjob_config.php";  
  ...
  if($cmdChange != "" && $rdomethod != ""){
    $oR3DCQuery->UpdateCronJobSettings($rdomethod);
  }

  $PChatSetting = $oR3DCQuery->GetCronJobSettings();

?>
<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_69", $config);?></title>
