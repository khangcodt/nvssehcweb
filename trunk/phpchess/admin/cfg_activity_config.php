<?php
  ...
  $Contentpage = "cell_admin_cfg_activity_config.php";  
  ...
  $slctFree = $_POST['slctFree'];

  if($cmdUpdate != "" && is_numeric($txtCredit) && $slctFree != ""){

    if(strpos($txtCredit, '.') === false){

      $oR3DCQuery->UpdateActivityConfigInfo($slctFree, $txtCredit);

    }

  }

  $oR3DCQuery->GetActivityConfigInfo($Free, $Credit);

?>

<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_58", $config);?></title>
