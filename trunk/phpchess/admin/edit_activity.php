<?php
  ...
  $Contentpage = "cell_admin_edit_activity.php";  
  ...
  $AID = $_GET['aid'];
  $cmdEnable = $_GET['cmdEnable'];
  $cmdDisable = $_GET['cmdDisable'];

  if($AID != "" && cmdEnable != ""){
    $oR3DCQuery->EnableActivity($AID);
  }

  if($AID != "" && $cmdDisable != ""){
    $oR3DCQuery->DisableActivity($AID);
  }

  $isenabled = $oR3DCQuery->IsActivityEnabled($AID);

?>

<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_52", $config);?></title>
