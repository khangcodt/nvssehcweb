<?php
  ...
  $Contentpage = "cell_admin_new_players.php";  
...
function ExecuteCommand(strCMD){
  ...
  if(strCMD == "A"){
    document.frmManageNewPlayers.txtcommand.value = "A"
    document.frmManageNewPlayers.submit();
  }else{
    if(strCMD == "R"){
      document.frmManageNewPlayers.txtcommand.value = "R"
      document.frmManageNewPlayers.submit();
    }
  }
