<?php
  ...
  $Contentpage = "cell_admin_cfg_pchat_config.php";  
  ...
  if($cmdChange != "" && $rdomethod != ""){
    $oR3DCQuery->UpdatePChatSettings($rdomethod);
  }

  $PChatSetting = $oR3DCQuery->GetPChatSettings();

?>
<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_68", $config);?></title>
