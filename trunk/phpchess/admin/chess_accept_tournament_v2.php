<?php
  ...
  $Contentpage = "cell_admin_chess_accept_tournament_v2.php";  
  ...
  if(is_numeric($accept) && is_numeric($type)){
    $oR3DCQuery->v2AcceptNewTournament($type, $accept);
  }

  if(is_numeric($remove) && is_numeric($type)){
    $oR3DCQuery->v2RejectNewTournament($type, $remove);
  }
...
<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_63", $config);?></title>
