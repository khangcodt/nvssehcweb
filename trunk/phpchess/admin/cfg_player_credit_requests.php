<?php
  ...
  $Contentpage = "cell_admin_cfg_player_credit_requests.php";  
  ...
  if($rid != "" && $tag == "accept"){
    $oR3DCQuery->AcceptCreditRequest($rid);
  }

  if($rid != "" && $tag == "decline"){
    $oR3DCQuery->DeclineCreditRequest($rid);
  }
...
<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_57", $config);?></title>
