<?php
  ...
  $Contentpage = "cell_admin_cfg_language.php";  
  ...
  $oLanguage = new CLanguage($config);
  ...
  $strname = trim($_POST['optlangname']);
  $cmdChange = trim($_POST['cmdChange']);

  if($cmdChange != "" && $strname != ""){
    $oLanguage->InstallLanguage($strname);
  }
...
<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_8", $config);?></title>
