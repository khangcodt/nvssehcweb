<?php
  ...
  $Contentpage = "cell_cfg_chessboard_colors.php";  
  ...
  $txtl = $_GET['txtl'];
  $txtd = $_GET['txtd'];
  $cmdchgcolor = $_GET['cmdchgcolor'];

  if($txtl != "" && $txtd != "" && $cmdchgcolor != ""){
    $oR3DCQuery->UpdateDefaultAdminChessboardColors($txtl, $txtd);
  }
...
<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_37", $config);?></title>
