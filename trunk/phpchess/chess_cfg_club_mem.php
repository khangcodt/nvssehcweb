<?php
  ...
  $Contentpage = "cell_chess_cfg_club_mem.php";  
  ...
  // Posted variables
  $cmdSend = $_POST['cmdSend'];
  $elm2 = $_POST['elm2'];

  if($cmdSend != "" && $elm2 != ""){
    $oR3DCQuery->UpdateClubPageHTML($_SESSION['id'], $elm2);
  }
...
<html>
<head>
<title><?php echo GetStringFromStringTable("IDS_PAGETITLES_29", $config);?></title>
