...
<script type="text/javascript">
	...
	{
		if (task == 'gameoption.cancel' || document.formvalidator.isValid(document.id('chessvn-form')))
		{
...
<input type="hidden" name="gameoptionid" value="<?php echo $this->item->gameoptionid; ?>" />
