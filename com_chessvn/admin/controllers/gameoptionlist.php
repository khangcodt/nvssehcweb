 ...
 * @subpackage 	Chessvn
 */
class ChessvnControllerGameoptionlist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Gameoption', $prefix = 'ChessvnModel', $cfg = array('ignore_request' => true)){
